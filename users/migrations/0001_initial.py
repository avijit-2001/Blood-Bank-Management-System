    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_rewarded', models.DateField(blank=True, null=True)),
                ('req', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='users.Request')),
            ],
        ),
        migrations.CreateModel(
            name='Reason',
            fields=[
                ...
                ('request', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='users.Request')),
            ],
        ),
        migrations.CreateModel(
            name='Hospital',
